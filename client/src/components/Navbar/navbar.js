...
class Navbar extends Component {
  ...
  render() {
    ...
    const isAdmin = user && user.role === 'admin';  // Kiểm tra vai trò admin
    ...
    const authLinks = (
      <React.Fragment>
        ...
        <div className="vr" />
        <div>
          <NavLink to="/search">Cho tui nhiều lựa chọn hơn đi</NavLink>
        </div>
        {isAdmin && (
          <div className="vr" />
        )}
    ...
    return (
      <div id="navbar">
        <div className="nav-items">
          ...
          <div className="rightButtons">{isAuthenticated ? authButtons : guestButtons}</div>
        </div>
      </div>
    );
  }
